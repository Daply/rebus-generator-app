...
public class RebusController {
    ...
    public boolean uploadNewWordImageForReview(@ModelAttribute KeyWordImage keyWordImage) throws IOException {
		...
		try {
			...
			boolean uploaded = fileProcessor.uploadNewImageForReview(keyWordImage.getWord(), keyWordImage.getLang(), keyWordImage.getFile());
			return uploaded;
    ...
    public boolean uploadNewWordImage(@ModelAttribute KeyWordImage keyWordImage) throws IOException {
		...
		try {
			fileProcessor.uploadNewImage(keyWordImage.getWord(), keyWordImage.getLang(), keyWordImage.getFile());
